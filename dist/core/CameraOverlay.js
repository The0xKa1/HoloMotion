...
export class CameraOverlay {
  ...
  render(_frame              , now        )       {
    ...
    return { left: (w - dw) / 2, top: (h - dh) / 2, width: dw, height: dh };
          ...
          projectLandmark(lm                          , rect                                                              , mirror         )                           {
    ...
    if (result.face) {
      this.drawFace(result.face, rect, mirror);
          ...
          drawPose(landmarks                      , rect                                          , mirror         )       {
    ...
    this.ctx.restore();
          ...
          drawHand(landmarks                      , rect                                          , mirror         )       {
    ...
    this.ctx.restore();
          ...
          drawFace(landmarks                      , rect                                          , mirror         )       {
